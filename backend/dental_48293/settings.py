"""
Django settings for dental_48293 project.
...
ROOT_URLCONF = 'dental_48293.urls'
...
WSGI_APPLICATION = 'dental_48293.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dental_48293 API",
    "DESCRIPTION": "API documentation for dental_48293 App",
    "VERSION": "v1",
}
